    ...
    TabsA.color-acento-contenido.mb-5(data-aos="fade-left")
      ...
      .tarjeta.color-primario.p-4(titulo="D. Progresión")
        ...
        ul.lista-ul--color
          ...
          li 
            i.fas.fa-gamepad(style="color: #8979F3")
            | #[b Recompensas (el score, títulos, logros y demás)]. Provocan que el jugador disfrute y explore más y se sienta mejor a medida que progresa, aunque no son la principal razón por la que las personas juegan, a excepción de algunos videojuegos de tipo abstracto que carecen de una historia que desarrollar.
